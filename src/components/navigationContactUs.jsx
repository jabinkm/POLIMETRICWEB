          ...
          >
            ...
            <motion.li whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Typography
                ...
                className="p-1 font-normal"
              >
                <Link to={"/contact-us"} className="flex items-center text-red-600 hover:text-red-600">
                  CONTACT US
                </Link>
              </Typography>
            </motion.li>
            ...
            <Collapse open={isOpen}>
              <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
                ...
                <Typography
                  ...
                  className="p-1 font-normal"
                >
                  <Link to={"/contact-us"} className="flex items-center text-red-600 hover:text-red-600" onClick={() => setIsOpen(false)}>
                    CONTACT US
                  </Link>
                </Typography>
              </ul>
